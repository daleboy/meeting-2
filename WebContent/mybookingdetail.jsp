...
<body>
	...
	<div class="page-content">
		<div class="content-nav">会议预定 > 修改我预定的会议</div>
		<form method="get" >
			<fieldset>
				<legend>会议信息</legend>
				<table class="formtable">
					...
					<tr>
						...
						<input type="button" class="clickbutton" value="取消会议" onclick="window.location.href='CancleMeetingSvl?meetingid=${requestScope.meeting.meetingid}'"/> 
